...
import com.sxmbit.fire.activity.ShapeActivity;
import com.sxmbit.fire.activity.ShoppingActivity;
import com.sxmbit.fire.activity.TextureActivity;
...
//            Intent intent = new Intent(getContext(), SrollActivity.class);
            Intent intent = new Intent(getContext(), TextureActivity.class);
            getContext().startActivity(intent);
            return true;
        });
        subMenu.add("扫一扫").setIcon(R.drawable.ic_filter_vintage_white_24dp).setOnMenuItemClickListener(item -> {
            Intent intent = new Intent(getContext(), ShapeActivity.class);
