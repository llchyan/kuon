...
public class NiftyNotificationView
{
    ...
    private NiftyOnClickListener onClickListener;
    ...
    private FrameLayout initializeCroutonViewGroup()
    {
        ...
        if (null != onClickListener)
        {
            notifyView.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    onClickListener.onClick(NiftyNotificationView.this);
                }
            });
        }
    ...
    public NiftyNotificationView setNiftyOnClickListener(NiftyOnClickListener onClickListener)
    {
    ...
    public interface NiftyOnClickListener
    {
        void onClick(NiftyNotificationView niftyNotificationView);
    }
