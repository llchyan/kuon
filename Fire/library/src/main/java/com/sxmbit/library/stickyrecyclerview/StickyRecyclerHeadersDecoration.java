package com.sxmbit.library.stickyrecyclerview;
...
import com.sxmbit.library.stickyrecyclerview.caching.HeaderProvider;
import com.sxmbit.library.stickyrecyclerview.caching.HeaderViewCache;
import com.sxmbit.library.stickyrecyclerview.calculation.DimensionCalculator;
import com.sxmbit.library.stickyrecyclerview.rendering.HeaderRenderer;
import com.sxmbit.library.stickyrecyclerview.util.LinearLayoutOrientationProvider;
import com.sxmbit.library.stickyrecyclerview.util.OrientationProvider;
...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration
{
     ...
     * 设置偏移，为头部view腾出一部分空间
     *
     * @param itemOffsets rectangle to define offsets for the item 矩形进行默认偏移
     * @param header      view used to calculate offset for the item  view用于计算偏移
     * @param orientation used to calculate offset for the item 计算偏移
     */
